...
export default function MatchesPage() {
  ...
  return (
    <Box sx={{ px: 2, pt: 4, maxWidth: 700, mx: 'auto' }}>
      <Typography variant="h4" gutterBottom>
        Find Your Top 5 Matches
      </Typography>
      <Typography sx={{ mb: 2 }}>
        Enter a keyword and we’ll show you the five posts whose embeddings match best.
      </Typography>
                  ...
                  secondary={
                    <>
                      <Typography component="span" variant="body2" color="text.primary">
                        {post.type === 'room' ? `Room • $${post.price ?? 'N/A'}` : 'Roommate'}
                      </Typography>
                      {' — '}
